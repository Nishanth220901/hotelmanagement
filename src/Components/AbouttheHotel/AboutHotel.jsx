    ...
    <div className='Container'>
      ...
      <div className='AboutName row'>
        ...
        <div className='AboutHotel col '>
          ...
          <p>Explore the charm of Coimbatore with ease, as H-Residency is surrounded by numerous attractions waiting to be discovered. Let our dedicated team and exceptional facilities exceed your expectations and create cherished memories during your stay. Experience luxury redefined at Holiday Residency.</p>
        </div>
